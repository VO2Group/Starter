...
As Starter can't provide the function directly to native code, a unique identifier is generated by `_uuid` function of `platform` object. Once the native code need to invoke the callback, it simply call `_invoke` function with the given identifier.
